        ...
        <div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          ...
          <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
            ...
            <p className="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel, veritatis tenetur! In, quo commodi pariatur itaque iure modi unde quisquam.
            </p>
            ...
            <div className="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
              <img
                src="https://tailwindtoolbox.github.io/App-Landing-Page/App%20Store.svg"
                className="h-12 pr-4 bounce-top-icons"
              />
              <img
                src="https://tailwindtoolbox.github.io/App-Landing-Page/Play%20Store.svg"
