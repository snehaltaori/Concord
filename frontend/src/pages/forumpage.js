...
const Forum = () => {
  ...
  useEffect(() => {
    const fetchThreadsAndReplies = async () => {
      try {
        ...
        setOriginalThreads(threadsWithReplies);
        setLoading(false);
      } catch (error) {
  ...
  return (
    <div className="body-vishal body-vishall">
    <div className="container mx-auto w-full pt-4" style={{ maxWidth: "90%" }}>
      <section className="main pt-4">
        ...
        <div className="flex flex-wrap">
          <div className="w-full lg:w-1/4 pr-4">
            <div className="card bg-gray-800 rounded-md mb-6">
          ...
          <div className="w-full lg:w-3/4">
            <div className="card bg-gray-800 rounded-md">
