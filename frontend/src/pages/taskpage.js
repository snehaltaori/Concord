...
function Taskpage() {
  ...
  return (
    <>
      <div className="container mx-auto w-full" style={{ maxWidth: "90%" }}>
          ...
          <div className="container task-container">
            ...
            <div className="grid grid-cols-3 lg:grid-cols-3 gap-4">
              <div className="col-span-1 task-section">
                ...
                <div className={`card rounded-md task-card ${completed ? "completed-task completed-text" : ""}`}>
                ...
                <div className={`card rounded-md task-card ${completed2 ? "completed-task completed-text" : ""}`}>
                  <div className="px-2 py-2 rounded-md card-header task-header">
                    <h5 className="text-white text-xl card-title">
                      Task 2 <br />
                      <small>Due 20/12/2023</small>
